...
{
    private static readonly string TokenEnumsPath = @"SOFTWARE\Microsoft\Speech\Voices\TokenEnums\NaturalVoiceEnumerator";
    ...
    public static void Register(Type t)
    {
        ...
        RegisterInprocServer(TTSEngineClsidPath, dllPath, "NaturalVoiceSAPIAdapter.TTSEngine");
        RegisterInprocServer(EnumeratorClsidPath, dllPath, "NaturalVoiceSAPIAdapter.VoiceTokenEnumerator");
